							...
							<tbody>
								@foreach ($skills as $skill)
									<tr>
										...
										<td>{{$skill->name}}</td>
										<td>
											<a href="{{route('editJobSkill', $skill->id)}}"><i class="la la-pencil-alt text-success mr-5"></i></a>
											<a style="cursor: pointer" onclick="deleteFunction('{{$skill->id}}') "><i class="la la-trash text-danger mr-5"></i></a>
										</td>
									</tr>
								@endforeach
							</tbody>
