					...
					<div class="d-flex align-items-baseline flex-wrap mr-5">
						...
						<ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
							<li class="breadcrumb-item">
								<a href="{{route('editLanguage', $language->id)}}" class="text-muted">{{__('Edit Language')}}</a>
							</li>
						</ul>
					</div>
				</div>
							...
							<div class="row">
								<div class="col-6">
									<div class="form-group">
										...
										<input type="text" class="form-control"  placeholder="Enter Language Name" name="name" value="{{$language->name}}" required />
										@error('name')
								...
								<div class="col-6">
									<div class="form-group">
										...
										<input type="text" class="form-control"  placeholder="Enter Language Name" name="name_ar" value="{{$language->name_ar}}" required />
										@error('name_ar')
											<span class="invalid-feedback" role="alert">
												{{ $message }}
											</span>
