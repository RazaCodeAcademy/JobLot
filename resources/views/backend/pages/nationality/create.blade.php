					...
					<div class="d-flex align-items-baseline flex-wrap mr-5">
						...
						<ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
							<li class="breadcrumb-item">
								<a href="{{route('createNationality')}}" class="text-muted">{{__('Create Nationality')}}</a>
							</li>
						</ul>
					</div>
				</div>
							...
							<div class="row">
								...
								<div class="col-6">
									<div class="form-group">
										...
										<input type="text" class="form-control"  placeholder="Enter Nationality Name" name="name_ar" value="{{old('name_ar')}}" required />
										@error('name_ar')
											<span class="invalid-feedback" role="alert">
												{{ $message }}
											</span>
