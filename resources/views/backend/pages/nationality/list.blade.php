                            ...
                            @php $No = 0; @endphp
								@foreach ($nationalities as $nationality)
                                    ...
                                    <tr>
										...
										<td style="text-align: center">{{$nationality->name}}</td>
										<td style="text-align: center">
											<a href="{{route('editNationality', $nationality->id)}}"><i class="la la-pencil-alt text-success mr-5"></i></a>
											<a style="cursor: pointer" onclick="deleteFunction('{{$nationality->id}}') "><i class="la la-trash text-danger mr-5"></i></a>
										</td>
									</tr>
								@endforeach
							</tbody>
