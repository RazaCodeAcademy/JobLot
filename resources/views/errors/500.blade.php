...
<div class="d-flex flex-column flex-root">
    <!--begin::Error-->
    <div class="d-flex flex-row-fluid bgi-size-cover bgi-position-center" style="background-image: url({{asset('public/backend/dist/assets/media/error/bg2.jpg')}});">
        <!--begin::Content-->
        <div class="d-flex flex-row-fluid flex-column justify-content-end align-items-center text-center text-white pb-40">
            ...
            <span class="display-4 font-weight-boldest mb-8">Something went wrong</span>
        </div>
        <!--end::Content-->
    </div>
    <!--end::Error-->
